...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap({ 'n', 'v' }, '<space>ca', '<cmd>vim.lsp.buf.code_action()<CR>', opts)
  buf_set_keymap('n', '<leader>r', '<cmd>vim.lsp.buf.rename()<CR>', opts)
...
local servers = { "solargraph", "tsserver", "sorbet", "eslint", "lua_ls" }
